...
\begin{table}[h!]
	\begin{tabular}{|l|l|l|l|l|}
		...
		\begin{tabular}[c]{@{}l@{}}Introduction au\\ Raspberry,\\ Premier \\programme\end{tabular} & \begin{tabular}[c]{@{}l@{}}Python\\ Types\\ Fonctions\end{tabular} & \begin{tabular}[c]{@{}l@{}}Python \\ Conditions\\ Boucles\end{tabular} & \begin{tabular}[c]{@{}l@{}}Coder un jeu\\ avec PyGame\end{tabular} & Station Météo %TODO                
		   \\ \hline
	\end{tabular}
\end{table}
...
\input{11_interactions_utilisateur}
...
\input{91_presentation}

\section{Mise en place}
\input{92_mise_en_place}

\section{Installation de l'OS}
\input{93_installation_os}
